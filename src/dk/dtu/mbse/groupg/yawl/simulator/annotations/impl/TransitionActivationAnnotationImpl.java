 ...
 * </p>
 * <ul>
 *   <li>{@link dk.dtu.mbse.groupg.yawl.simulator.annotations.impl.TransitionActivationAnnotationImpl#getMode <em>Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransitionActivationAnnotationImpl extends ObjectAnnotationImpl implements TransitionActivationAnnotation {
	...
	protected EClass eStaticClass() {
		return AnnotationsPackage.Literals.TRANSITION_ACTIVATION_ANNOTATION;
	}
	...
	public void setMode(Mode newMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnnotationsPackage.TRANSITION_ACTIVATION_ANNOTATION__MODE, oldMode, mode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AnnotationsPackage.TRANSITION_ACTIVATION_ANNOTATION__MODE:
				return getMode();
		}
